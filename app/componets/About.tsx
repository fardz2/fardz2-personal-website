...
export default function About() {
  return (
    <>
      <section className="  py-5 h-screen" id="about">
          ...
          <div className="flex  justify-center md:mt-0 mt-20  flex-col lg:flex-row gap-20 items-center  ">
            ...
            <Fade initial={10} animate={0} delay={0.5}>
              <div className="overflow-hidden">
                <Image
                  src={"/assets/faridz.jpg"}
                  alt={"faridz"}
                  width={700}
                  height={700}
                  className="object-cover !m-0 !p-0 object-top  w-[200px]  md:w-[1300px] h-[500px] rounded-[10px]  relative "
                />
              </div>
            </Fade>
          </div>
